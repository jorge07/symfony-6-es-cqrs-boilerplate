...
class SecurityControllerTest extends WebTestCase
{
     ...
     * @group e2e
     */
    public function login_should_display_an_error_when_bad_credentials()
    {
        $client = self::createClient();
        ...
        $crawler = $client->followRedirect();
        self::assertEquals(1, $crawler->filter('html:contains("An authentication exception occurred.")')->count());
    }
